...
class GLLineShader : public QSGSimpleMaterialShader<State>
{
    QSG_DECLARE_SIMPLE_COMPARABLE_SHADER(GLLineShader, State)

    int id_color;

    public:
        const char *vertexShader() const override {
            QFile file(":/line.vert");
