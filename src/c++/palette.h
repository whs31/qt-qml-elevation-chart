...
class Palette : public QObject
{
  ...
  public:
    ...
    [[nodiscard]] QColor background() const; void setBackground(const QColor& color);
    [[nodiscard]] QColor foreground() const; void setForeground(const QColor& color);
    [[nodiscard]] QColor overlay() const;    void setOverlay(const QColor& color);
    [[nodiscard]] QColor accent() const;     void setAccent(const QColor& color);
